...
Vagrant.configure("2") do |config|
    ...
    # Exponer el puerto interior de la caja ** Para Puerto Personalizado **
    config.vm.network "forwarded_port", guest: 4800 , host: 4800 , auto_correct: true
  
    # Exponer el puerto interior de la caja ** Para proyecto NodeJs **
    config.vm.network "forwarded_port", guest: 3000 , host: 3000 , auto_correct: true # Original
  
    # Exponer el puerto interior de la caja ** Para MySQL  **
    config.vm.network "forwarded_port", guest: 3306 , host: 3306 , auto_correct: true # Original
  
    # Exponer el puerto interior de la caja ** Para MongoDB  **
    config.vm.network "forwarded_port", guest: 27057 , host: 27057 , auto_correct: true # Original
